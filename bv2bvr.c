/*
 *
 * BV2BVR - Boardview converter for OpenBoardView. 
 * 
 * Separate utility, GPL2.0 licenced, to convert MS Access / JET
 * formatted BV files in to plain-text BVR that OpenBoardView can
 * access (legally)
 *
